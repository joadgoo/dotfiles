...
alias vtest="LOG_LEVEL=error npx vitest run --no-threads --no-isolate --bail=1"
alias vtestd="LOG_LEVEL=error npx vitest run --no-threads --no-isolate --bail=1 --inspect-brk"
